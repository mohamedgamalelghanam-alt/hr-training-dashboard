...
try:
    ...
    st.error("⚠️ لم يتم العثور على ملف البيانات 'Training.xlsx - Sheet1.csv'. تأكد من وجود الملف في نفس مسار تشغيل المشروع.")
    st.stop()
...
with col3:
    ...
    # Pie charts for Completed and Certificate side by side in plotly
...
with col5:
    # Summary Table for top/bottom performing departments
